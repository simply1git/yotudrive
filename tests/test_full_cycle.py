...
def test_full_cycle():
    ...
    # Should be frame_00000000.png, frame_00000001.png, etc.
    if not os.path.exists(os.path.join(extracted_dir, "frame_00000000.png")):
        print("FAIL: Extracted frames do not start at 0! (frame_00000000.png missing)")
        # List first few files
        print("First 5 files:", sorted(extracted_files)[:5])
        return
    else:
        print("  frame_00000000.png found (0-based indexing confirmed).")
