...
def test_header_redundancy():
    ...
    for i in range(DEFAULT_HEADER_COPIES):
        frame_path = os.path.join(frames_dir, f"frame_{i:08d}.png")
    ...
    if not os.path.exists(os.path.join(frames_dir, f"frame_{body_frame_start:08d}.png")):
    ...
    os.remove(os.path.join(frames_dir, "frame_00000000.png"))
    print("  Deleted frame_00000000.png")
    ...
    img1_path = os.path.join(frames_dir, "frame_00000001.png")
    ...
    img1.save(img1_path)
    print("  Corrupted frame_00000001.png (Bit 64 forced to 0)")
    
    # Corrupt frame 2 (Corrupt Bit 64 - force to 1/White)
    img2_path = os.path.join(frames_dir, "frame_00000002.png")
    ...
    img2.save(img2_path)
    print("  Corrupted frame_00000002.png (Bit 64 forced to 1)")
