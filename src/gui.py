...
class YotuDriveGUI:
            ...
            try:
                ...
                for idx, current_file in enumerate(files_to_process):
                    ...
                    if os.path.isdir(output_path):
                        video_file = os.path.join(output_path, f"{base_name}_{timestamp}.mp4")
                    else:
    ...
    def _restore_file_internal(self, video_path, output_dir, password, auto_cleanup, threads, check_cancel_func, progress_base=0, progress_scale=1.0):
        ...
        try:
            ...
            output_file_temp = os.path.join(output_dir, f"{video_name}_restored") 
            ...
            decoder = Decoder(frames_dir, output_file_temp, password=password, progress_callback=decode_cb, threads=threads, check_cancel=check_cancel_func)
            decoder.run()
